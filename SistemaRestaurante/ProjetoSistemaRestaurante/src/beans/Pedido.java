...
public class Pedido {
    ...
    public String toString() {
        return this.quantidade_comida + "x " + this.id_comida.getNome() + " Valor : R$" + this.quantidade_comida * this.id_comida.getValor() + 
                "\n\n" + "Bebida: " + this.quantidade_bebida + "x " + this.id_bebida.getNome()  + " Valor : R$" + this.quantidade_bebida * this.id_bebida.getValor() +
                "\n\n" + "Sobremesa: " +  this.quantidade_sobremesa + "x " + this.id_sobremesa.getNome()  + " Valor : R$" + this.quantidade_sobremesa * this.id_sobremesa.getValor() +

...
public class PedidosDAO {
    ...
    public void inserir(Pedido pedido){
        ...
        String sql = "INSERT INTO Pedido (id_mesa, id_comida, quantidade_comida, valor_comida, id_bebida, quantidade_bebida, valor_bebida, id_sobremesa, quantidade_sobremesa, valor_sobremesa) VALUES (?,?,?,?,?,?,?,?,?,?);";
